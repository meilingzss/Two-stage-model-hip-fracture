...
df <- read.csv("/Users/mac/Desktop/2026twostage/2026newy/UKfrax_female_newtscore.8var.dataset.csv", header = TRUE, stringsAsFactors = FALSE)

# Columns to convert
cols_to_factor <- c("smoke", "hip")
...
clinical_features <- c(  "height","smoke","weight","age")


dxa_features <- c("neckbmd_Tscore")
target_col <- "hip"
